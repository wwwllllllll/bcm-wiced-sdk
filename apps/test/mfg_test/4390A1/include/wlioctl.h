 ...
 *
 * $Id: wlioctl.h 391410 2013-03-18 06:11:13Z cylee $
 */
...
typedef struct tcp_keepalive_mac_wake_pkt_info {
	uint32          pktlen;		/* size of packet */
	uchar 		packet[ETHER_MAX_DATA];
} tcp_keepalive_wake_mac_pkt_info_t;
