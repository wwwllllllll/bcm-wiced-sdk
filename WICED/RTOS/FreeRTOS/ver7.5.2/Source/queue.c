...
/*@null@*/ /*@out@*/ /*@only@*/ xQueueHandle xQueueGenericCreate( unsigned portBASE_TYPE uxQueueLength, unsigned portBASE_TYPE uxItemSize, unsigned char ucQueueType )  /*@defines *result@*/
{
xQUEUE *pxNewQueue;
...
signed portBASE_TYPE xQueueGenericSend( xQueueHandle xQueue, /*@null@*/ const void * const pvItemToQueue, portTickType xTicksToWait, portBASE_TYPE xCopyPosition )
{
...
signed portBASE_TYPE xQueueGenericSendFromISR( xQueueHandle xQueue, /*@null@*/ const void * const pvItemToQueue, /*@out@*/ signed portBASE_TYPE *pxHigherPriorityTaskWoken, portBASE_TYPE xCopyPosition )
{
...
signed portBASE_TYPE xQueueGenericReceive( xQueueHandle xQueue, /*@null@*/ /*@out@*/ const void * const pvBuffer, portTickType xTicksToWait, portBASE_TYPE xJustPeeking ) /*@modifies internalState@*/
{
signed portBASE_TYPE xEntryTimeSet = pdFALSE;
xTimeOutType xTimeOut;
signed char *pcOriginalReadPosition;
...
void vQueueDelete( /*@only@*/ xQueueHandle xQueue )
{
xQUEUE * const pxQueue = ( xQUEUE * ) xQueue;
