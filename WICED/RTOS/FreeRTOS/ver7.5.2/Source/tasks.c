...
signed portBASE_TYPE xTaskGenericCreate( pdTASK_CODE pxTaskCode, const signed char * const pcName, unsigned short usStackDepth, /*@null@*/ void *pvParameters, unsigned portBASE_TYPE uxPriority, /*@out@*/ xTaskHandle *pxCreatedTask, /*@null@*/ portSTACK_TYPE *puxStackBuffer, /*@null@*/ const xMemoryRegion * const xRegions )
{
...
static portTASK_FUNCTION( prvIdleTask, pvParameters )
{
	...
	for( ;; )
	{
		...
		#if ( configUSE_IDLE_NO_TICK_SLEEP_HOOK == 1 )
		{
			...
			uxPendedTicks += platform_power_down_hook( (xNextTaskUnblockTime==0xffffffff)? 0xffffffff : xNextTaskUnblockTime - tmp_xTickCount );
			xTaskResumeAll();
		}
		#endif
...
{
	signed char *       out = pxTCB->pcTaskName;
	const signed char * in  = pcName;
