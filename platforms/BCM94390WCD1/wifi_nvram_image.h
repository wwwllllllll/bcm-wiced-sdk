...
//# Sample variables file for BCM94390 FcBGA Development Package IPA board (2.4GHz ONLY eDiv, eTR,iPA and iLNA)
// This nvram came from Jovica after testing on a 4390 module : 11-Mar-2013
static const char wifi_nvram_image[] =
        "NVRAMRev=$Rev: 387583 $"                                                                      "\x00"
        "sromrev=11"                                                                                   "\x00"
        "boardrev=0x1111"                                                                              "\x00"
        "boardtype=0x069a"                                                                             "\x00"
