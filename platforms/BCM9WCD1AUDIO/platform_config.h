...
/** @file
 * Defines internal configuration of the BCM9WCD1AUDIO board
 */
#pragma once
...
/******************************************************
 *  WICED Audio Constants and Options
 ******************************************************/

/*  I2S DMA flags */
#define I2S1_DMA_FLAG_TC  ( DMA_FLAG_TCIF4 )
#define I2S1_DMA_IT_TCIF  ( DMA_IT_TCIF4   )
#define I2S1_DMA_IT_TEIF  ( DMA_IT_TEIF4   )

/*  DAC uses a external oscillator */
