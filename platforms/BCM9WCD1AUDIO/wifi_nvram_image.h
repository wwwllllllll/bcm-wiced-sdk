...
/** @file
 *
 *  Sample variables file for BCM9WCD1AUDIO based on SSB-WM-N02 module that has
 *  BCM43362 Package IPA board (2.4GHz ONLY eDiv, eTR,iPA and iLNA)
 */
...
static const char wifi_nvram_image[] =
        ...
        "vendid=0x14e4"                                                      "\x00"
        "devid=0x4343"                                                       "\x00"
        "boardtype=0x06d2"                                                   "\x00"
        "boardrev=0x1102"                                                    "\x00" /*Board Revision is REV102*/
        "boardnum=777"                                                       "\x00"
        "xtalfreq=26000"                                                     "\x00"
