...
// Sample variables file for BCM94390 module (customer version) based on SPIL SB-WM-N03 SiP (2.4GHz ONLY)
// To be used with BCM9WCD4EVAL2 eval board
static const char wifi_nvram_image[] =
        "NVRAMRev=$Rev: 387583 $"                                                                      "\x00"
        "sromrev=11"                                                                                   "\x00"
        "boardrev=0x1102"                                                                              "\x00"
        "boardtype=0x0702"                                                                             "\x00"
